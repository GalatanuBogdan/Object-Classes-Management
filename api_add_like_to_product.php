...
$table_name = "product_reviews_likes";
...
function addLike($productID)
{
    ...
    $successMsg = 'like was added';
    die($successMsg);
}

function removeDislike($productID)
{
    global $conn, $table_name_dislikes;

    $removeQuery = "DELETE FROM $table_name_dislikes WHERE ipAddress = ? AND productID = ?";
